...
function readSavedUser() {
  ...
  try { return { ...fallbackUser, ...JSON.parse(savedUser) } as PlatformUserData; } catch { return fallbackUser; }
}
  ...
  return (
    <main className="platform-page">
      ...
      <section className="platform-workspace">
        ...
        <section className="page-placeholder-card"><h1>Расписание</h1><p>Здесь будет календарь мероприятий, дедлайны, встречи команд и личное расписание пользователя на платформе.</p></section>
      </section>
    </main>
  );
};
