...
const mockParticipants = [
  ...
  { id: 3, name: "София Иванова", role: "UX/UI-дизайнер" },
  { id: 4, name: "Максим Волков", role: "Руководитель проекта" },
];

const mockTeams = [
  { id: 1, name: "Пиксельный Пульс", members: ["АС", "ИП", "СИ"] },
  { id: 2, name: "Кодовая Орбита", members: ["МВ", "АС", "ИП"] },
  { id: 3, name: "Северные Звезды", members: ["СИ", "МВ", "АС"] },
  { id: 4, name: "Вектор Спринта", members: ["ИП", "СИ", "МВ"] },
];
...
const mockEvents = [
  {
    ...
    description:
      "Интенсив по созданию современного интерфейса с командной работой и защитой итогового решения.",
  ...
  },
  {
    ...
    description:
      "Практическое мероприятие по проектированию API, работе с базами данных и серверной логике.",
    teamSize: "4 участника",
    date: "7 июня 2026",
  },
  {
    id: 3,
    title: "Дизайн-спринт UX/UI",
    description:
      "Спринт для дизайнеров с быстрым прототипированием, исследованием пользователей и презентацией концепции.",
                ...
                <section className="admin-participants-list" aria-label="Список участников">
                  {mockParticipants.map((participant) => (
                    <article key={participant.id} className="admin-participant-card">
                      ...
                      <button
                        type="button"
                        className="admin-participant-more"
                ...
                <section className="admin-teams-list" aria-label="Список команд">
                  {mockTeams.map((team) => (
                    <article key={team.id} className="admin-team-card">
                      ...
                      <button
                        type="button"
                        className="admin-team-more"
                        aria-label={`Подробнее о команде ${team.name}`}
                      >
