...
var timeoutsShape = import_prop_types$5.default.oneOfType([import_prop_types$5.default.number, import_prop_types$5.default.shape({
	enter: import_prop_types$5.default.number,
	exit: import_prop_types$5.default.number,
	appear: import_prop_types$5.default.number
}).isRequired]);
var classNamesShape = import_prop_types$5.default.oneOfType([
...
var ReplaceTransition = /* @__PURE__ */ function(_React$Component) {
	_inheritsLoose(ReplaceTransition$1, _React$Component);
	function ReplaceTransition$1() {
		var _this;
	...
	var _proto = ReplaceTransition$1.prototype;
	...
	_proto.render = function render() {
		...
		return /* @__PURE__ */ import_react.createElement(TransitionGroup_default, props, inProp ? import_react.cloneElement(first, {
			key: "first",
...
var callHook = function callHook$1(element, name, cb) {
	return function() {
		var _element$props;
...
var SwitchTransition = /* @__PURE__ */ function(_React$Component) {
	_inheritsLoose(SwitchTransition$1, _React$Component);
	function SwitchTransition$1() {
		var _this;
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this;
		_this.state = {
	...
	var _proto = SwitchTransition$1.prototype;
	_proto.componentDidMount = function componentDidMount() {
		this.appeared = true;
	};
	SwitchTransition$1.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
...
//#endregion
export { CSSTransition_default as CSSTransition, ReplaceTransition_default as ReplaceTransition, SwitchTransition_default as SwitchTransition, Transition_default as Transition, TransitionGroup_default as TransitionGroup, config_default as config };
